...
int main()
{
    ...
    double mass(1);
    bool dag(true);
    int dim4x(25), dim4t(25), dim4s(8), rank, size;
    const int nu4dim(25 * 25 * 8);
    Vector<complex<double>, nu4dim> U= VectorXcd::Ones(nu4dim);
    Vector<complex<double>, nu4dim> b= VectorXcd::Ones(nu4dim);
    b(nu4dim - 1) = 10;
